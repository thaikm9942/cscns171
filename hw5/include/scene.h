...
class Scene {
    public:
        ...
        // Add a labeled object to the scene given an object and its label and its corresponding mesh data
        void add_labeled_object(Object obj, string label, Mesh_Data* mesh_data);
